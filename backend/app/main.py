...
# Import routers
from app.routers import auth, categories, products, search, cart, orders, delivery, admin, admin_rbac, seller, rider, assistant
...
app.include_router(rider.router, prefix=api_v1_prefix)
